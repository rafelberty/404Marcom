...
<%@ Page language="c#" Inherits="ASPNetPortal.RTLDesktopDefault" CodeFile="RTLDesktopDefault.aspx.cs" %>
						...
						<table align=left width="100%" cellspacing="0" cellpadding="0" border="0">
							<tr height="*" valign="top">
								...
								<td align="left" width="100%">
									<span id="MainBodySpanTag" runat="server" >
									<table width="100%" cellspacing="0" cellpadding="0" border="0">
									<tr><td>
								...
								</td><td class="ModuleWidthSeparator"></td>	
								<td align="left" width="100%">
