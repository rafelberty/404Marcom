...
namespace ASPNetPortal 
{
    ...
    public partial class DesktopDefault : System.Web.UI.Page 
	{
        ...
        protected string userNTLMDomainID = "";
		...
		protected void Page_Init(object sender, EventArgs e) 
		{
			...
			if(ConfigurationSettings.AppSettings["HeaderSetGreetingMessage"]=="")
			{
                ...
                //Response.Write("<script LANGUAGE='JavaScript' >alert('" + ASPNetPortal.Components.PortalSecurity.UserName+ "')</script>");          
                //Response.Write("<script LANGUAGE='JavaScript' >alert('" + LDAP.LDAPManager.getUserFullName(ASPNetPortal.Components.PortalSecurity.UserName).ToString() + "')</script>");          
			}
			else
			{
			...
			TopLevelLinks_js = ps.GlobalLinksUrl.ToString();
				...
				{
					Response.Redirect(ConfigurationManager.AppSettings["apppath"]+"DesktopDefault.aspx?tabid=1&tabindex=0");
				}
				...
				{
                    Response.Redirect(ConfigurationManager.AppSettings["apppath"] + "Admin/AccessDenied.aspx");
				}
