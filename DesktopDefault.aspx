...
<%@ Page language="c#" Inherits="ASPNetPortal.DesktopDefault" ValidateRequest="false" CodeFile="DesktopDefault.aspx.cs" Debug="true" AutoEventWireup="false" %>
...
<HTML id="PageHTMLTag" runat="server">
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0">
		...
		<!--script language="javascript" type="text/javascript" > alert("hello 1");</script>
		<script language="javascript" type="text/javascript" src="<%=(ConfigurationSettings.AppSettings["apppath"])%>javascripts/horizontalnav.js"></script>
		-->
		...
		<script src="<%=(ConfigurationSettings.AppSettings["apppath"])%>javascripts/cal2.js" language="javascript" type="text/javascript" ></script>
		<!--End: ToolBar V2.0-->
		...
		<form runat="server" name="DesktopDefault">
