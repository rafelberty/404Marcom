...
namespace ASPNetPortal 
{
    ...
    public partial class RTLDesktopDefault : System.Web.UI.Page 
	{
		...
		protected void Page_Init(object sender, EventArgs e) 
		{
			...
			// Handle the Page Right-To-Left Needs
			PageHTMLTag.Attributes.Add("dir", "ltr");
			MainBodySpanTag.Attributes.Add("dir", "rtl");
			...
			{
                HeaderSetGreetingMessage = "setGreetingMessage('<span align=right>Welcome &nbsp;" + ASPNetPortal.Components.PortalSecurity.UserFullName + "</span>');";
			}
			else
			{
